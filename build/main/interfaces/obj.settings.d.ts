...
export declare type IField = IFieldBase | IFieldSelect;
...
export declare type IFieldSelectMatchStrategy = 'fuzzy' | 'exact';
export interface IFieldSelect extends Omit<IFieldBase, 'type'> {
    type: 'select';
    matchStrategy?: IFieldSelectMatchStrategy;
    options: IFieldOption[];
}
export declare type IValidator = IValidatorRegexDictionary | IValidatorRequiredWithDictionary | IValidatorOtherDictionary;
...
export interface IValidatorRequiredWithValuesDictionary extends IBaseValidatorDictionary {
    validate: 'required_with_values' | 'required_with_all_values' | 'required_without_values' | 'required_without_all_values';
    fieldValues: ScalarDictionary;
}
export declare type IValidatorRequiredWithDictionary = IValidatorRequiredWithSimpleDictionary | IValidatorRequiredWithValuesDictionary;
...
export declare type IFieldOption = IFieldOptionDictionary;
